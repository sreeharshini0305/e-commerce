            ...
            <div className='w-full min-h-[150px] flex items-center gap-x-4'>
                ...
                <div className='flex-grow flex flex-col'>
                    ...
                    <div className='flex justify-between md-2'>
                        ...
                        {/* remove icon */}
                        <div onClick={()=>removeFromCart(id)}className='text-xl cursor-pointer ml-auto'>
                    ...
                    <div className='flex gap-x-2 h-[36px] text-sm'>
                        ...
                        <div className='flex flex-1 max-w-[100px] items-center h-full border text-primary font-medium'>
                            {/* minus icon */}
                            <div onClick={()=>decreaseAmount(id)} className='flex-1 h-full flex justify-center items-center cursor-pointer h-full'><IoMdRemove/></div>
                            {/* amount */}
